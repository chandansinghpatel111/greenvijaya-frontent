  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-end">
      ...
      <a
        ...
        className="group flex items-center bg-gradient-to-tr from-[#1a0c0f] to-[#3d1e24] border border-[#d4af37]/30 text-white rounded-full shadow-xl hover:shadow-2xl hover:border-[#d4af37] transition-all duration-300 overflow-hidden h-[50px]"
