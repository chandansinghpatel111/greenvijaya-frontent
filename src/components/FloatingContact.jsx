  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-end">
      ...
      >
        ...
        <span className="whitespace-nowrap overflow-hidden max-w-0 group-hover:max-w-xs group-hover:px-2 group-hover:-ml-2 transition-all duration-300 font-medium text-sm">
          Call: +91 9450058323
        </span>
      </a>
      ...
      <a
        ...
        className="group flex items-center bg-[#e0a973] text-white rounded-full shadow-xl hover:shadow-2xl hover:bg-[#d19b66] transition-all duration-100 overflow-hidden h-[50px]"
      ...
      >
        ...
        <span className="whitespace-nowrap overflow-hidden max-w-0 group-hover:max-w-xs group-hover:px-2 group-hover:-ml-2 transition-all duration-100 font-medium text-sm">
          Chat on WhatsApp
        </span>
      </a>
    </div>
