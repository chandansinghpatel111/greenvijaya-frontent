...
import logo from "../assets/WhatsApp Image 2025-05-24 at 14.01.33_c41ade66.jpg"; // Add your logo image here
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center h-12">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <Link to="/" className="text-2xl font-bold text-blue-500 rounded">
              UNIQUE USD
            </Link>
          </div>
