      ...
      <div className="flex h-screen">
        ...
        <div className="w-64 bg-orange-600 text-white p-4">
          ...
          <ul className="space-y-4">
            <li className="cursor-pointer hover:text-gray-300" onClick={() => navigate("/admin/ourproject")}>
              OurProjects
            </li>
            ...
            <li className="cursor-pointer hover:text-gray-300" onClick={() => navigate("/admin/ComingSoon")}>
              Coming Soon project
            </li>
            <li className="cursor-pointer hover:text-gray-300" onClick={() => navigate("/admin/Apartments")}>
              Apartments, Villas, and More
            </li>
            <li className="cursor-pointer hover:text-gray-300" onClick={() => navigate("/admin/Buys")}>
              Buys
            </li>
          </ul>
        </div>
